...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 29-Nov-2023 às 18:17
...
CREATE TABLE IF NOT EXISTS `curriculos` (
  ...
  `cnh_a` tinyint(1) DEFAULT NULL,
  `cnh_outros` varchar(1) DEFAULT NULL,
  `celular` varchar(15) DEFAULT NULL,
  `contato_tipo` varchar(30) DEFAULT NULL,
  ...
  `curso_formacao` varchar(255) DEFAULT NULL,
  `instituicao_ensino` varchar(255) DEFAULT NULL,
  `inicio_formacao` year DEFAULT NULL,
  `fim_formacao` year DEFAULT NULL,
  `outros_cursos_formacao` varchar(255) DEFAULT NULL,
  `ingles` varchar(100) DEFAULT NULL,
  `espanhol` varchar(100) DEFAULT NULL,
  `informatica` varchar(100) DEFAULT NULL,
  `office` varchar(100) DEFAULT NULL,
  `outras_habilidades` varchar(255) DEFAULT NULL,
  `obj_area_atuation` varchar(255) DEFAULT NULL,
  `Conhecimento_geral` varchar(255) DEFAULT NULL COMMENT 'Conhecimento_geral',
  `conhecimento_informatica` varchar(255) DEFAULT NULL,
  `created` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `experiencias` (
  `id` int NOT NULL AUTO_INCREMENT,
  `curriculo_id` int DEFAULT NULL,
  `empresa` varchar(255) DEFAULT NULL,
  `inicio` year DEFAULT NULL,
  `fim` year DEFAULT NULL,
...
(6, NULL, 'admin@admin.com', '$2y$10$lvFstLcEuzyWs.sYopQAc.meqr4vNvr0P7vCqkbXyHvyRt0.LBntS', '1', '2023-11-14 19:26:33', '2023-11-16 16:37:55'),
(8, NULL, 'israelsilva1310@gmail.com', NULL, NULL, '2023-11-29 17:19:13', '2023-11-29 17:19:13');
...
CREATE TABLE IF NOT EXISTS `vagas` (
  ...
  `vale_alimentacao` tinyint(1) DEFAULT '1',
  `vale_refeicao` tinyint(1) DEFAULT NULL,
  `vale_combustivel` tinyint(1) DEFAULT NULL,
